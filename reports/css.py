...
def _stylesheet() -> str:
    ...
    return "\n".join(
        (
            ...
            ".sticky-header { position: sticky; top: 0; z-index: 10; background: rgba(246, 248, 250, 0.96); backdrop-filter: blur(8px); padding-bottom: 12px; }",
            ...
            ".toolbar-button { padding: 10px 12px; border-radius: 10px; border: 1px solid var(--border); background: var(--surface-alt); cursor: pointer; font: inherit; font-weight: 600; }",
            ...
            ".comparison-table th { word-break: normal; }",
            ".comparison-table .sort-button { white-space: nowrap; }",
            ".comparison-table .empty-row td { white-space: normal; word-break: normal; }",
            ".comparison-scroll-shell { max-height: 28rem; overflow: auto; }",
            ".data-table tr.comparison-diff-row td { background: #fff8de !important; }",
            ".data-table tr.comparison-diff-row td:first-child, .data-table tr.comparison-diff-row td:nth-child(2) { background: #ffe7a3 !important; color: #5f370e !important; font-weight: 700; }",
            ".data-table td.comparison-diff { background: #ffd666 !important; color: #5f370e !important; font-weight: 700; box-shadow: inset 0 0 0 9999px rgba(255, 214, 102, 0.92); }",
            ...
            "@media (max-width: 900px) { .page-shell { padding: 16px; } .page-header-card, .toolbar-card, .section-card, .about-card { padding: 14px; } }",
        )
    )
